...
#b)
prelim <- mh_multivariate(x, priors, cand_S=.01*diag(2), init=c(1,1), B=2000, burn=10000)
out_b <- mh_multivariate(x, priors, cand_S=cov(prelim$post), init=tail(prelim$post,1), B=2000, burn=10000)
